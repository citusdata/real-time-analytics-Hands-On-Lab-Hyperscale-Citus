...
WHERE ingest_time > date_trunc('minute', now()) - interval '5 minutes' LIMIT 15;
```
## 6.	In the Psql console copy and paste the following to create a report for the top 10 urls in the last 5 minutes. If you observe the query uses topn_union_agg to aggregate the minutely aggregates over the last 5 minutes.
```
